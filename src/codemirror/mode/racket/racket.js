(function(mod) {
  ...
  CodeMirror.defineMode("racket", function(_config) {
    ...
    const specialForm = /^(and|check-error|check-expect|check-member-of|check-random|check-range|check-satisfied|check-within|cond|define|define-struct|else|if|lambda|local|or|quote|require)$/;
